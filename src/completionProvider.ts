...
import {  BUILT_IN_TEMPLATES, processTemplate } from '@brainfile/core';
...
export class BrainfileCompletionProvider implements vscode.CompletionItemProvider {
  provideCompletionItems(
    ...
    const indent = this.getIndentation(linePrefix);
  ...
  private getPriorityCompletions(): vscode.CompletionItem[] {
    return [
      this.createValueCompletion('critical', '🔴 Highest priority - urgent issues', 'constant.language.priority.critical'),
